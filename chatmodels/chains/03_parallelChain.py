...
model_1 = init_chat_model("ollama:mistral-large-3:675b-cloud", temperture=0.7)
model_2 = init_chat_model("ollama:gemini-3-flash-preview:cloud", temperture=0.3)


prompt1 = PromptTemplate(
    template="generate simple and understanded detaied notes on given text.\n {text}",
    input_variables=['text']
)

prompt2 = PromptTemplate(
    template="generate 10 question on the given text.\n {text}",
    input_variables=['text']
)
...
text = """
lass sklearn.linear_model.LinearRegression(*, fit_intercept=True, copy_X=True, tol=1e-06, n_jobs=None, positive=False)
[source]
